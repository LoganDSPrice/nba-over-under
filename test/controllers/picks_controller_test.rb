...
class PicksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pick" do
    assert_difference('Pick.count') do
      post picks_url, params: { pick: { contestant_id: @pick.contestant_id, lock: @pick.lock, over: @pick.over, team_id: @pick.team_id } }
    end
  ...
  test "should update pick" do
    patch pick_url(@pick), params: { pick: { contestant_id: @pick.contestant_id, lock: @pick.lock, over: @pick.over, team_id: @pick.team_id } }
