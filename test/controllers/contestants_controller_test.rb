...
class ContestantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contestant" do
    assert_difference('Contestant.count') do
      post contestants_url, params: { contestant: { email: @contestant.email, name: @contestant.name } }
    end
  ...
  test "should update contestant" do
    patch contestant_url(@contestant), params: { contestant: { email: @contestant.email, name: @contestant.name } }
